          ...
          <div className={styles.brandColumn}>
            ...
            <div className={styles.socialMedia}>
              <a href="#" className={styles.socialIcon}>
                <Image src="/restof/Footer insta icon.svg" alt="Instagram" width={32} height={32} />
              </a>
              <a href="#" className={styles.socialIcon}>
                <Image src="/restof/Footer FB icon.svg" alt="Facebook" width={32} height={32} />
              </a>
              <a href="#" className={styles.socialIcon}>
                <Image src="/restof/Footer Gmail icon.svg" alt="Email" width={32} height={32} />
              </a>
            </div>
