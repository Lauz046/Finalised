...
import styles from './AccessoriesMobileFilterOverlay.module.css';

interface AccessoriesMobileFilterOverlayProps {
  show: boolean;
  onClose: () => void;
  sortBy: string;
...
const AccessoriesMobileFilterOverlay: React.FC<AccessoriesMobileFilterOverlayProps> = ({
  show,
  onClose,
  sortBy,
  onSortByChange,
...
export default AccessoriesMobileFilterOverlay;