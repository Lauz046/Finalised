...
const PerfumeFilterSidebar: React.FC<PerfumeFilterSidebarProps> = ({
  show,
  onHide: _onHide,
  sortBy,
  onSortByChange,
  ...
  return (
    <aside className={show ? styles.sidebar : styles.sidebarHidden}>
      ...
      <div className={styles.section}>
        ...
        {fragranceFamilyExpanded && (
          <div className={styles.brandOptions}>
            {fragranceFamilies.map(fragranceFamily => (
              <label key={fragranceFamily} className={styles.checkboxLabel}>
                <input
                  type="checkbox"
                  checked={selectedFragranceFamilies.includes(fragranceFamily)}
                  onChange={() => onFragranceFamilyChange(fragranceFamily)}
                />
                {fragranceFamily}
              </label>
            ))}
...
export default PerfumeFilterSidebar; 